...
export const saveTrack: Track = {
  ...
  sequence: [
    ...
    },
    {
      ...
      id: "market-day",
      label: "CHOICE",
      blurb: "Resist the soft drink stall and keep money safe in the piggy box.",
      icon: "🥤",
      reward: 10,
    },
    {
    ...
    },
    {
      ...
      id: "little-by-little",
      label: "EARNING",
      blurb: "Helped shell groundnuts and earned honest chore pocket money.",
      icon: "🥜",
      chip: "+GH₵15 Earned",
      reward: 15,
    },
    ...
    },
    {
      ...
      id: "school-shoes",
      label: "SURPRISE",
      blurb: "Handle an unexpected sandal repair with your emergency stash.",
      icon: "🩴",
      reward: 0,
    },
    {
